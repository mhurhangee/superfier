import { SidebarGroup, SidebarGroupLabel, SidebarGroupContent, SidebarMenuItem, SidebarMenuButton, SidebarMenuAction } from "@/components/ui/sidebar"
            ...
            <SidebarGroupContent>
                {chats.map((chat: Chat) => (
                    <SidebarMenuItem key={chat.id}>
                        ...
                        <SidebarMenuAction showOnHover className="md:opacity-0 group-hover/menu-item:opacity-100 transition-opacity">
                            <DropdownMenu>
