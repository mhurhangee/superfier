export const promptBuilder = (persona: string, creativity: string, responseLength: string) => {
  ...
  switch (persona) {
    ...
    case 'developer':
      prompt +=
        '- You specialize and are an expert in coding, debugging and developing. \n- Your response should focus on writing code to solve the problem.'
      break
    case 'legal':
      prompt +=
        '- You specialize and are an expert in legal matters. \n- Your response must be professional and accurate.'
      break
    case 'friendly':
      prompt +=
    ...
    case 'scientific':
      prompt +=
        '- You specialize and are an expert in scientific matters. \n- Your response must be professional and accurate.'
      break
    case 'nerd':
      prompt +=
        '- You specialize and are an expert in nerd matters. \n- Your response should be as geeky and nerdy as possible.'
      break
    default:
      prompt += '- You are a helpful assistant.\n'
      break
