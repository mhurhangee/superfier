...
const handleDeleteMessage = ({ index, messages, setMessages, reload }: handleDeleteMessageProps) => {
...
const handleRegenerateResponse = ({ index, messages, setMessages, reload }: handleDeleteMessageProps) => {
    if (index % 2 === 1) {
...
const startEditingMessage = ({ index, messages, setEditingMessageIndex, setEditingMessageContent }: startEditingMessageProps) => {
...
export const cancelEditingMessage = ({ setEditingMessageIndex, setEditingMessageContent }: CancelEditingMessageProps) => {
...
export const saveEditedMessage = ({ messages, setMessages, setEditingMessageIndex, setEditingMessageContent, reload, editingMessageIndex, editingMessageContent }: saveEditedMessageProps) => {
